<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
        <div class="form-group">
            <label for="varchar">Kode Obat <?php echo form_error('kode_barang') ?></label>
            <input type="text" class="form-control" name="kode_barang" id="kode_barang" placeholder="Kode Obat" value="<?php echo $kode_barang; ?>" />
        </div>
        <div class="form-group">
            <label for="varchar">Nama Obat <?php echo form_error('nama_barang') ?></label>
            <input type="text" class="form-control" name="nama_barang" id="nama_barang" placeholder="Nama Obat" value="<?php echo $nama_barang; ?>" />
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label for="int">Foto Obat </label>
            <input type="file" class="form-control" name="foto_barang" />
        </div>
        <div class="form-group">
            <label for="int">Jenis Obat </label>
